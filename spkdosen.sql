...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 01, 2017 at 06:32 AM
...
INSERT INTO `dosen` (`id_dosen`, `nip`, `nidn`, `nama`, `temp_lahir`, `tgl_lahir`, `jk`, `id_jur`, `no_sk`, `pend_tertinggi`, `jabatan_akademik`, `id_golongan`, `lokasi`, `foto`, `username`, `password`, `level`) VALUES
(1, '12', '12', 'zaza', 'malang', '2017-10-04', 'L', 1, '1212', 'SD', '1', '1', 'Q', 'SDS', 'zaza', 'zaza', '1');
...
INSERT INTO `pendidikan` (`id_pendidikan`, `id_dosen`, `unsur`, `sub`, `uraian`, `tempat`, `tanggal`) VALUES
(1, NULL, NULL, NULL, NULL, NULL, NULL),
(2, 1, 1, 1, 1, 'gasek', '0000-00-00'),
(3, 1, 1, 1, 1, 'tt', '0000-00-00'),
(4, 1, 3, 13, 40, 'malang', '2017-10-03'),
(5, 1, 1, 1, 2, 'fh', '0000-00-00'),
(6, 1, 1, 1, 2, 'd', '2017-10-13'),
(7, 1, 1, 1, 1, 'dds', '0000-00-00'),
(8, 1, 1, 2, 10, '45dru6', '0000-00-00'),
(9, 1, 1, 1, 1, 'UNIV', '2017-11-03'),
(10, 1, 1, 1, 1, 'UIN', '2017-11-17');
...
INSERT INTO `penelitian` (`id_penelitian`, `id_dosen`, `unsur`, `sub`, `uraian`, `judul`, `link`, `lampiran`) VALUES
(0, 1, 3, NULL, NULL, 0, 'gdxsg', NULL),
(1, 1, 1, 1, 2, NULL, NULL, NULL);
...
INSERT INTO `unsur_kegiatan` (`id_unsur`, `nama_unsur`, `kategori`) VALUES
(1, 'Unsur Pendidikan', ''),
...
--
ALTER TABLE `dosen`
 ADD PRIMARY KEY (`id_dosen`), ADD KEY `id_jur` (`id_jur`);
...
ALTER TABLE `pengabdian`
 ADD PRIMARY KEY (`id_pengabdian`), ADD KEY `id_dosenpeng` (`id_dosen`);

--
-- Indexes for table `pengajaran`
--
ALTER TABLE `pengajaran`
 ADD PRIMARY KEY (`id_pengajaran`), ADD KEY `id_dosenpengaj` (`id_dosen`);

--
-- Indexes for table `penunjang`
--
ALTER TABLE `penunjang`
 ADD PRIMARY KEY (`id_penunjang`), ADD KEY `id_dosenpenun` (`id_dosen`);
...
ADD CONSTRAINT `id_dosenpend` FOREIGN KEY (`id_dosen`) REFERENCES `dosen` (`id_dosen`);
...
ADD CONSTRAINT `id_dosenpene` FOREIGN KEY (`id_dosen`) REFERENCES `dosen` (`id_dosen`);

--
-- Constraints for table `pengabdian`
--
ALTER TABLE `pengabdian`
ADD CONSTRAINT `id_dosenpeng` FOREIGN KEY (`id_dosen`) REFERENCES `dosen` (`id_dosen`);

--
-- Constraints for table `pengajaran`
--
ALTER TABLE `pengajaran`
ADD CONSTRAINT `id_dosenpengaj` FOREIGN KEY (`id_dosen`) REFERENCES `dosen` (`id_dosen`);

--
-- Constraints for table `penunjang`
--
ALTER TABLE `penunjang`
ADD CONSTRAINT `id_dosenpenun` FOREIGN KEY (`id_dosen`) REFERENCES `dosen` (`id_dosen`);
...
--
ALTER TABLE `uraian_kegiatan`
ADD CONSTRAINT `fk_keg` FOREIGN KEY (`id_sub`) REFERENCES `sub_kegiatan` (`id_sub`);
