			...
			<div class="box-body">
				...
				<?= form_open_multipart('admin/Dosen/TambahDosen',['class'=>'form-vertical'])?>
					<div class="form-group">
						<label>NIP :</label>
						<input class="form-control" type="text" name="nip" placeholder="NIP" value="<?= set_value('nip')?>"></input>
					</div>
					<div class="form-group">
						<label>NAMA LENGKAP :</label>
						<input class="form-control"  type="text" name="namaLengkap" placeholder="Nama Lengkap"></input>
					</div>
					<div class="form-group">
						<label>PANGKAT :</label>
					...
					<div class="form-group">
						...
						<input class="form-control" type="text" name="unitKerja" placeholder="unit kerja"></input>
					</div>
					<div class="form-group">
						<label>JURUSAN</label>
